...
이 종국 · 김 옥희의 장녀  민영`,
  ...
  transport: [
    { type: '지하철 + 도보', desc: '4호선 혜화역 4번 출구 도보 8분' },
    { type: '지하철 + 버스', desc: '4호선 혜화역 1번 출구 앞에서 마을버스 7번 탑승, 성균관대 정문 하차' },
    { type: '셔틀버스', desc: '4호선 혜화역 4번 출구 T스토어 앞에서 셔틀버스 운행' },
    { type: '버스', desc: [
      '간선 100, 102, 104, 107, 140, 143, 150, 151, 160, 162, 171, 172, 272, 301, 710번',
      '지선 8101, 8111번',
      '광역 1101, 7101번 ' ],
    },
    { type: '주차', desc: [
      '네비게이션 "성균관컨벤션웨딩홀" 검색. 본관 주차장, 제1주차장, 성균관대학교 주차장.',
      '하객주차 2시간 무료 (성균관대학교 정문 안 주차팀 안내 배치)' ]
    },
  ],
  ...
  accounts: [
    ...
    },
    {
      ...
      people: [
        ...
        { role: '신부 부', name: '이종국', bank: '신한은행', account: '110-355-228190' },
        { role: '신부 모', name: '김옥희', bank: '하나은행', account: '429-018690-00207' },
      ],
    }
